<main>
        ...
        <div id='courses_list' class='col-xs-12 col-xs-offset-1'>
            <div class='col-xs-12 course'>
                ...
                <div class='col-xs-2 image_container'>
                    <a href="<?=BASE_PATH?>milestones/showTasks/<?=$group->proId?>">
                ...
                <div class='col-md-10 col-xs-10'>
                    ...
                    <div class='col-md-12'>
                        <div class='col-md-offset-4'>
                            <a href="<?=BASE_PATH?>tasks/showTasks/<?=$group->proId?>" class='btn btn-primary c-btn'>View Tasks</a>
                        </div>
                    </div>
                    <!--    // ------- CONTENT WRAPPER-->
                </div>
    ...
    ?>
    <link type="text/css" rel="stylesheet" href="<?=BASE_PATH?>views/public/css/tasks/groupList.css">
</main>